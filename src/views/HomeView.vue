    ...
    <main>
        ...
        <section class="relative min-h-screen bg-stone-950 flex flex-col justify-center overflow-hidden">
            ...
            <div class="absolute inset-0">
                <MediaImage :src="mediaSrc('home.hero')" :alt="mediaAlt('home.hero')"
                    class="w-full h-full object-cover opacity-25" />
                <div class="absolute inset-0 bg-linear-to-b from-stone-950/50 via-stone-950/70 to-stone-950"></div>
            </div>

            <!-- Geometric accent -->
            <div class="absolute top-24 right-0 w-72 h-72 border border-amber-400/10 rounded-full translate-x-1/2"></div>
            <div class="absolute bottom-32 left-0 w-48 h-48 border border-amber-400/10 rounded-full -translate-x-1/2"></div>
            ...
            <div class="relative max-w-6xl mx-auto px-5 pt-28 pb-20">
                <div class="max-w-3xl">
                    ...
                    <h1 class="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-[1.1] mb-6">
        ...
        <section class="bg-stone-900 border-y border-stone-800">
            <div class="max-w-6xl mx-auto px-5 py-10 grid grid-cols-2 md:grid-cols-4 gap-6">
                <div v-for="stat in stats" :key="stat.label" class="text-center">
                    <p class="font-display text-3xl font-bold text-amber-400">{{ stat.value }}</p>
        ...
        <section class="bg-white py-20">
            <div class="max-w-6xl mx-auto px-5 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="aspect-4/3 rounded-lg overflow-hidden bg-stone-100">
        ...
        <section class="bg-amber-400 py-16">
            <div
                class="max-w-6xl mx-auto px-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                <div>
